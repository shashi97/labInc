...
export class OrderReviewComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.getPracticeDDO();
    this.breadcrumbsService.breadcrumbs = 'Dashboard / Review Orders';
  ...
  public selectSearchDate() {
    ...
    if (Number(this.orderFilter.DateTypeSelect) === 3) {
      let today = date
    ...
    if (Number(this.orderFilter.DateTypeSelect) === 4) {
  ...
  public SearchOrderByFilterObject() {
    ...
    if (!this.isParamObjBlank) {
      this.router.navigate(['/' + this.localStorageService.getModuleName() + '/order/orderReview'],
        {
          queryParams: {
            ...
            ProcessingLabId: this.orderFilter.ProcessingLabId, StatusId: 4,
  ...
  private viewOrder(id: number, orderNo: string) {
    ...
    this.router.navigate(['/' + this.localStorageService.getModuleName() + '/order/orderReview/' + id + '/' + orderno + '/view'],
      {
        queryParams: {
          NetworkType: this.orderFilter.NetworkType, DateTypeSelect: this.orderFilter.DateTypeSelect,
          FromDate: this.orderFilter.FromDate, ToDate: this.orderFilter.ToDate, PreferredLabId: this.orderFilter.PreferredLabId,
